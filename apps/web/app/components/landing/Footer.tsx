...
const navigation = {
  solutions: [
    { name: "Product Checker", href: "#" },
    { name: "Personalized Reports", href: "#" },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <div className="flex items-center space-x-2">
              <Dna className="h-8 w-8 text-sky-600" />
              <span className="text-2xl font-bold text-gray-800 dark:text-white">SupplementScribe</span>
            </div>
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-300">
              Clarity and safety in the supplement aisle.
            </p>
          </div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 dark:border-white/10">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} SupplementScribe. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
